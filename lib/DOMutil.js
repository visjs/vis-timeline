 ...
 * @private
 */
export function prepareElementsJSONcontainer) {
 ...
 * @private
 */
export function cleanupElementsJSONcontainer) {
  // cleanup the redundant svgElements;
  for (var elementType in JSONcontainer) {
    if (JSONcontainer.hasOwnProperty(elementType)) {
 ...
 * @param {Object} JSONcontainer
 */
export function resetElementsJSONcontainer) {
 ...
 */
export function drawPointx, y, groupTemplate, JSONcontainer, svgContainer, labelObj) {
  var point;
