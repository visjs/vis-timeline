  ...
  _repaintOnItemUpdateTimeTooltip(anchor) {
    ...
    if (this.dom.onItemUpdateTimeTooltip) {
      ...
      if (this.options.tooltipOnItemUpdateTime && this.options.tooltipOnItemUpdateTime.template) {
        ...
        content = `start: ${getLuxonDateTime(this.data.start, this.options.timezone).toFormat('dd/MM/yyyy HH:mm')}`;
        if (this.data.end) { 
          content += `<br> end: ${getLuxonDateTime(this.data.end, this.options.timezone).toFormat('dd/MM/yyyy HH:mm')}`;
        }
      }
