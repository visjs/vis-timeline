 ...
 */
  ...
  _repaintDeleteButton(anchor) {
    ...
    if (this.selected && editable && !this.dom.deleteButton) {
      ...
      let locales = this.options.locales[this.options.locale];
      if (!locales) {
        if (!this.warned) {
        ...
        locales = this.options.locales['en']; // fall back on english when not available
      }
      deleteButton.title = locales.deleteSelected;
