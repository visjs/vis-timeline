 ...
 */
  ...
  _updateDirtyDomComponents() {
    ...
    if (this.dirty) {
      ...
      const editable = (this.editable.updateTime || this.editable.updateStartTime || this.editable.updateEndTime || this.editable.updateGroup);
      const groupEditable = this.editable.updateGroup;
      const timeMovable = this.editable.updateTime && this.editable.updateStartTime && this.editable.updateEndTime
   ...
   */
  _repaintDragLeft() {
    if ((this.selected || this.options.itemsAlwaysDraggable.range) && this.editable.updateTime && this.editable.updateStartTime && !this.dom.dragLeft) {
    ...
    else if (((!this.selected && !this.options.itemsAlwaysDraggable.range) || !this.editable.updateStartTime) && this.dom.dragLeft) {
      // delete drag area
   ...
   */
  _repaintDragRight() {
    if ((this.selected || this.options.itemsAlwaysDraggable.range) && this.editable.updateTime && this.editable.updateEndTime && !this.dom.dragRight) {
      // create and show drag area
    ...
    else if (((!this.selected && !this.options.itemsAlwaysDraggable.range) || !this.editable.updateEndTime) && this.dom.dragRight) {
      // delete drag area
