 ...
 */
  ...
  setOptions(options) {
    if (options) {
      ...
      const fields = [
        ...
        'multiselectPerGroup', 'multiselectLongPressTime', 'groupOrder', 'dataAttributes', 'template', 'groupTemplate', 'visibleFrameTemplate',
  ...
  redraw() {
    ...
    this.hammer.get('press').set({time: this.options.multiselectLongPressTime});
