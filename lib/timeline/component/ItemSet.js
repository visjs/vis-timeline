 ...
 */
   ...
   */
  setItems(items) {
    this.itemsSettingTime = DateTime.now();
    const me = this;
    let ids;
          ...
          if (props.dragLeft) {
            ...
            if (this.options.rtl) {
              if (itemData.end != null) {
                initialEnd = util.convert(props.data.end, 'DateTime');
              ...
              if (itemData.start != null) {
                initialStart = util.convert(props.data.start, 'DateTime');
            ...
            if (itemData.start != null) {
              initialStart = props.data.start.toMillis();
              start = props.data.start.plus({milliseconds: offset});

              if (itemData.end != null) {
                initialEnd = props.data.end.toMillis();
  ...
  _cloneItemData(itemData, type) {
    ...
    if (clone.start != null) {
      clone.start = util.convert(clone.start,  'DateTime', this.options.timezone);
    }
    if (clone.end != null) {
      clone.end = util.convert(clone.end , 'DateTime', this.options.timezone);
    }
