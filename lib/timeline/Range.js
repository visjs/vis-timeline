  ...
  setOptions(options) {
    if (options) {
      ...
      const fields = [
        ...
        'moment', 'activate', 'hiddenDates', 'zoomKey', 'zoomFriction', 'rtl', 'showCurrentTime', 'rollingMode',
        'horizontalScroll', 'horizontalScrollKey', 'horizontalScrollInvert', 'verticalScroll'
      ];
