        ...
        if (duration >= 4 * pixelTime) {
          ...
          switch (hiddenDates[i].repeat) {
            case "daily": // case of time
              ...
              endDate = endDate.subtract(7 - offset,'days');

              runUntil = runUntil.add(1, 'weeks');
              break;
            case "weekly": {
              ...
              // force
              startDate = startDate.day(day);
              endDate = endDate.day(day);
              endDate = endDate.add(dayOffset,'days');
            ...
            case "monthly":
              ...
              endDate = endDate.add(offset,'months');

              runUntil = runUntil.add(1, 'months');
              break;
            case "yearly":
              ...
              endDate = endDate.add(offset,'years');

              runUntil = runUntil.add(1, 'years');
              break;
            default:
