...
class Core {
    ...
    /**
     * Resets custom vertical bar - If custom bar exists (with the same id exists), delete the old custom timebar at previous time point and set it again.
     * @param {Date | string | number} [time]  A Date, unix timestamp, or
     *                                         ISO date string. Time point where
     *                                         the new bar should be placed.
     *                                         If not provided, `new Date()` will
