...
class Core {
  ...
  setOptions(options) {
    if (options) {
      ...
      const fields = [
        'width', 'height', 'minHeight', 'maxHeight', 'autoResize', 'verticalAuto',
  ...
  _redraw() {
    ...
    if (!options.verticalScroll ||  props.center.height < props.centerContainer.height && !options.verticalAuto) {
