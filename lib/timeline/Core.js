...
class Core {
    ...
    setOptions(options) {
        if (options) {
            ...
            const fields = [
                ...
                'locale', 'locales', 'preferZoom', 'rtl', 'zoomKey',
                'horizontalScroll', 'verticalScroll', 'longSelectPressTime', 'snap',
                'luxonDateTime', 'timezone'
            ];
            ...
            if ('hiddenDates' in this.options) {
                DateUtil.convertHiddenOptions(this.body, this.options.hiddenDates, this.options.timezone);
            }
     ...
     */
    _toTime(x) {
        return DateUtil.toTime(this, x, this.props.center.width, this.options.timezone);
    }
     ...
     */
    _toGlobalTime(x) {
        return DateUtil.toTime(this, x, this.props.root.width, this.options.timezone);
