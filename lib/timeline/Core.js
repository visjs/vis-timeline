    ...
    _create(container) {
        ...
        function onMouseWheel(event) {
            ...
            if (this.options.horizontalScroll)
            {
                ...
                if (this.options.horizontalScrollInvert && isCurrentlyScrollingWithVerticalScrollWheel)
                    diff = -diff;
    ...
    setOptions(options) {
        if (options) {
            ...
            const fields = [
                ...
                'horizontalScroll', 'horizontalScrollKey', 'horizontalScrollInvert',
                'verticalScroll', 'longSelectPressTime', 'snap'
            ];
